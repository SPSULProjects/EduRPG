// tests/auth-logging-pii-fixed.spec.ts
// Fixed version of auth logging PII tests without logEvent dependency
import { describe, it, expect } from "vitest";
import { redactPII, safePayload } from "@/src/lib/security/redact";

describe("Authentication Logging PII Redaction - Fixed", () => {
  describe("Login Rate Limit Logging", () => {
  ...
  describe("Password Management Logging", () => {
